...
class _RegisterPageState extends ConsumerState<RegisterPage> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                usernameTxtField(
                    'Nombre completo', Icons.person_2_outlined, Icons.text_fields_rounded, fullname, false, () {}),
                usernameTxtField(
                    'Correo electrónico', Icons.email_outlined, Icons.alternate_email_sharp, email, false, () {}),
                usernameTxtField(
    ...
    return AbsorbPointer(
      ...
      child: Container(
          ...
          child: OutlinedButton(
              ...
              child: dosisText((!btnManager) ? 'Crear cuenta' : 'Creando la cuenta...',
  ...
  RichText questionAccount() {
    return RichText(
      textAlign: TextAlign.left,
      text: TextSpan(
        style: const TextStyle(fontSize: 20, color: Colors.white, fontFamily: 'Dosis'),
        children: <TextSpan>[
          const TextSpan(text: 'Ya tienes una cuenta? ', style: TextStyle(fontWeight: FontWeight.bold)),
          TextSpan(
            text: 'Inicia sesión',
