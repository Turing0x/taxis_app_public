...
class MiUbicacionBloc extends Bloc<MiUbicacionEvent, MiUbicacionState> {
  ...
  void iniciarSeguimiento() {
    ...
    _positionSubscription = Geolocator.getPositionStream(locationSettings: LocationSettings(accuracy:LocationAccuracy.high ,distanceFilter: 10 )).listen(( Position position ) {
