...
import 'package:taxis_app_public/Map_app/helpers/debouncer.dart';
import 'package:taxis_app_public/Map_app/models/reverse_query_response.dart';

import 'package:taxis_app_public/Map_app/models/search_response.dart';
import 'package:taxis_app_public/Map_app/models/traffic_response.dart';
...
class TrafficService {
  ...
  Future<SearchResponse> getResultadosPorQuery( String busqueda, LatLng proximidad ) async {
    ...
    try {
      ...
      return SearchResponse( features: [], type: '', attribution: '', query: [] );
    }
